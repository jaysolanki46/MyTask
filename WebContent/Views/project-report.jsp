                    	 ...
                    	 <!--  Custom search -->
                            ...
                            <div style="overflow: auto;    height: 40rem;    width: 100%;">
                             <button type="submit" title="Search"
											class="btn btn-sm btn-light active mr-3 center_div card-button"
											style="background-color:<%=bckColor %>; "
											onclick="exportTableToCSV('Project-report.csv');">
						  ...
						  <table id="exportProjectDataTable" class="table table-bordered" style="border: hidden;">
						    ...
						    <tfoot>
							    	<tr>
							    		...
							    		<%
							    		for (LocalDate date = LocalDate.parse(projectCreatedOn); date.isBefore(LocalDate.now().plusDays(3)); date = date.plusDays(1)) {
							    			%>
							    				<th>-</th>
							    			<%
							    		}
...
function exportTableToCSV(filename) {
	...
	var csv = [];
	var rows = document.getElementById('exportProjectDataTable').getElementsByTagName('tr');
