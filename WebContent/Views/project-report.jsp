...
<title>Skyzer - My Task | Project Report</title>
...
<%
	...
	reportProject = request.getParameter("selectProject");
...
#projectDataTable .sticky-col {
  position: -webkit-sticky;
  position: sticky;
  background-color: #eee;
}

#projectDataTable .first-col {
  width: 100px;
  min-width: 100px;
  max-width: 100px;
  left: 0px;
                ...
                <main>
                            ...
                            <div class="card-body"  style="padding: 0px;">
                               <div class="container-fluid">
										    ...
										    <div class="modal-dialog modal-xl" role="document">
										        <div class="modal-content" style="height: 40rem;">
										            <div class="modal-header">
										                <h5 class="modal-title">Project Report Tutorial</h5>
										                <button class="close" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
										            </div>
										            <div class="modal-body">
										                <iframe id="tutorialiframe" height="100%" width="100%" src="https://www.youtube.com/embed/T-ArvD21Xwk"></iframe>
										            </div>
										        </div>
										    </div>
										</div>
                                ...
                                <nav class="nav nav-borders nav-width">
                                    ...
                                    <a class="nav-link active ml-0" style="color: <%=bckColor %>; border-bottom-color: <%=bckColor %>;"  href="/MyTask/Views/project-report.jsp">Project</a>
                    ...
                    <div class="container">
                    	 ...
                    	 <!--  Custom search -->
											...
											<select class="form-control col-sm-4" id="selectProject" name="selectProject" required>
												...
												rs = st.executeQuery("SELECT projects.* FROM projects "
													...
													%>
														...
														<%
															if(reportProject != null && reportProject.equals(rs.getString("id"))) {
																%>selected<%
															}	
														%>
                            ...
                            <table id="projectDataTable" class="table table-bordered" style="border: hidden; overflow-x: auto; display: block;">
						    <thead>
							      <tr>
							        ...
							        <%
							        	...
							        	while(rs.next()){
							        		projectCreatedOn = rs.getString("created_on");
						  ...
						  <table id="exportProjectDataTable" class="table table-bordered" style="border: hidden;">
						    <thead>
							      <tr>
							      	<th>Project</th>
							        ...
							        <th>Progress</th><%
							        	...
							        	while(rs.next()){
							        		projectCreatedOn = rs.getString("created_on");
									        for (LocalDate date = LocalDate.parse(projectCreatedOn); date.isBefore(LocalDate.now().plusDays(1)); date = date.plusDays(1)) {
									        	%><th><%=date.getDayOfMonth() + "/" + date.getMonthValue() + "/" + date.getYear() %></th><% 
									        }
							        	}
						    ...
						    <tfoot>
							    	<tr>
							    		...
							    		for (LocalDate date = LocalDate.parse(projectCreatedOn); date.isBefore(LocalDate.now().plusDays(6)); date = date.plusDays(1)) {
							    			%>
							    				<th></th>
							    			<%
							    		}
...
var oTable = $('#projectDataTable').DataTable({
  paging: false,
  "language": {
    "search": "Table search: "
  },
...
$('#projectDataTable tbody').on('click', 'tr.group-start', function() {
